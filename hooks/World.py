...
def before_create_items_starting(item_pool: list, world: World, multiworld: MultiWorld, player: int) -> list:
    TROPHY_MAP = {"Super Mario Kart": 15, "Mario Kart 64": 16, "Mario Kart Super Circuit":30, "Mario Kart Double Dash!!":20, "Mario Kart DS":32, "Mario Kart Wii":32, "Mario Kart 7": 32, "Mario Kart 8": 60, "Mario Kart World": 32}
    ...
    if trophy_count == 0:
        for i in get_option_value(multiworld, player, "enabled_games"):
            if i == "Mario Kart 8" and get_option_value(multiworld, player, "enable_booster_course_pass"):
                trophy_count += TROPHY_MAP[i]*2
            else:
